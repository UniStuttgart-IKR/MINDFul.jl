function testsuitefailingintime!(ibnfs)
    ...
    TM.testexpectedfaileddag(getidag(remoteibnf_border), remoteintentid_border, Edge(58,25), 1)
    ...
    TM.testexpectedfaileddag(getidag(remoteibnf_external_fail), remoteintentid_external_fail, externaledge, 2)
